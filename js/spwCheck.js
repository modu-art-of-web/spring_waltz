var spwCheck = new function(){

    var _this = this;
    _this.isTouch = !!('ontouchstart' in window);
    _this.isMouse = !!('onmousedown' in window);
    ...
    if (!Modernizr.canvas || !Modernizr.canvastext) {
        ...
        _this.vendor = (Array.prototype.slice.call(styles).join('').match(/-(moz|webkit|ms)-/) || (styles.OLink === '' && ['', 'o']))[1];
        if (_this.vendor == "moz") _this.vendor = "Moz";
    }
    if (_this.vendor != 'webkit' && _this.vendor != 'Moz' && _this.vendor != 'ms') {
